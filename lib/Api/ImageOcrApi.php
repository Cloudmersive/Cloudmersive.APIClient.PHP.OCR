...
class ImageOcrApi
{
     ...
     */
    public function imageOcrPost($image_file)
    {
        list($response) = $this->imageOcrPostWithHttpInfo($image_file);
        return $response;
    }
     ...
     */
    public function imageOcrPostWithHttpInfo($image_file)
    {
        $returnType = '\Swagger\Client\Model\ImageToTextResponse';
        $request = $this->imageOcrPostRequest($image_file);
     ...
     */
    public function imageOcrPostAsync($image_file)
    {
        return $this->imageOcrPostAsyncWithHttpInfo($image_file)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageOcrPostAsyncWithHttpInfo($image_file)
    {
        $returnType = '\Swagger\Client\Model\ImageToTextResponse';
        $request = $this->imageOcrPostRequest($image_file);
     ...
     */
    protected function imageOcrPostRequest($image_file)
    {
